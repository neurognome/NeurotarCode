classdef NeurotarDataExtractor < handle
    ...
    methods (Access = protected)
        ...
        function extractData(obj,behaviour_data)
            obj.extractedData = struct();
            obj.extractedData.X     = cell2mat(behaviour_data(2:end, 7)); % their X and Y are flipped on their data sheet
            obj.extractedData.Y     = cell2mat(behaviour_data(2:end, 8));
            obj.extractedData.r     = cell2mat(behaviour_data(2:end, 4));
            obj.extractedData.phi   = cell2mat(behaviour_data(2:end, 5));
            obj.extractedData.alpha = cell2mat(behaviour_data(2:end, 6));
            obj.extractedData.omega = cell2mat(behaviour_data(2:end, 11));
            obj.extractedData.speed = cell2mat(behaviour_data(2:end, 12));
            obj.extractedData.time  = cell2mat(behaviour_data(2:end, 1));
            obj.extractedData.zones = cell2mat(behaviour_data(2:end, 13));
        end
    end
end